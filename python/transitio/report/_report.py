...
transitio's local tier-two notices and a hosted canonical report merge
...
def build_report(validation, *, hosted=None, provenance=None):
    ...
    ----------
    validation : dict
        The ``transitio.validate_feed`` result.
...
def _validator_stamp():
    ...
    return {"name": "transitio", "version": transitio.__version__}
...
def render_markdown(report):
    ...
    lines = [
        ...
        "",
        f"transitio {summary['validator']['version']} — {summary['generatedAt']}",
        "",
...
def render_html(report):
    ...
    return (
        ...
        f"<p>transitio {e(summary['validator']['version'])} — "
